...
window[b[1]](c,h,!1))};g=function(){try{var a=window.frames[d];"undefined"===typeof a.stop?a.document.execCommand("Stop"):a.stop()}catch(m){}document.body.removeChild(e);window[b[1]](c,h,!1);console.warn("Exec aborted")};window[b[0]](c,h,!1);"function"===typeof a&&(a="("+a.toString()+")()");f.open();f.write("<script>var returnData = function(data,transferableList) { parent.postMessage(['"+d+"',data],"+JSON.stringify(document.location.href)+",transferableList); };"+a+"\x3c/script>");f.close()})};
exec.prototype=Object.create(Promise.prototype);exec.prototype.constructor=exec;exec.prototype["catch"]=function(a){this.promise["catch"](a);return this};exec.prototype.then=function(a,d){this.promise.then(a,d);return this};exec.prototype.stop=function(){return this.stop()};
