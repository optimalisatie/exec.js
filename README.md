...
In some modern browsers (Chrome 55+) the code is executed in a separate thread (multithreading). (see Chrome [OOPIF](https://www.chromium.org/developers/design-documents/oop-iframes)). Chrome 55+ is used by over 50% of all internet users ([reference](https://www.w3schools.com/Browsers/default.asp)).
...
Include `exec-fetch.js` (250 bytes) in the HTML document.
