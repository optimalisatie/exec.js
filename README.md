...
In some modern browsers the code may be executed in a separate thread (multithreading) without the latency disadvantage of WebWorkers and with less code. ([OOPIF](https://www.chromium.org/developers/design-documents/oop-iframes))
